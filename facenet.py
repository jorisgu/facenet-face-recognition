...
FRmodel = load_model('weights_keras.h5')
...
def prepare_database():
    ...
    for file in glob.glob("images/*"):
        ...
        print("Id",identity,"loading...")
        database[identity] = img_path_to_encoding(file, FRmodel)
        print("Id",identity,"loaded.")
...
def webcam_face_recognizer(database):
    ...
    while vc.isOpened():
        ...
        if ready_to_detect_identity:
            ...
            pool.apply_async(process_frame, [img, frame, face_cascade])
...
if __name__ == "__main__":
    ...
    print("Starting webcam_face_recognizer function.")
